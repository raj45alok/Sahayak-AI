...
const [profileData, setProfileData] = useState<any>(null);
 ...
 const loadProfile = async () => {
  try {
    const response = await profileAPI.getTeacherProfile(user?.userId || '');
    if (response.success) {
      ...
      setFormData({
        ...
        classInfo: response.data.classInfo || user?.classInfo || '',
        bio: response.data.bio || 'Passionate educator with 10+ years of experience...',
        phone: response.data.phone || '+91 9876543210',
        qualification: response.data.qualification || 'M.Ed in Mathematics, B.Sc in Mathematics',
        experience: response.data.experience || '12 years',
        subjects: response.data.subjects || user?.subjects || ['Mathematics', 'Physics']
      });
    }
  } catch (error) {

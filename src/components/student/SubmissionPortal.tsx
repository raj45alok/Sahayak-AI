...
export function SubmissionPortal() {
  ...
  return (
    <div className="space-y-6 w-full px-0 mx-0">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 w-full">
            {pendingAssignments.map((assignment) => (
              <Card key={assignment.id} className="w-full glass-effect border-2 border-orange-500/20 shadow-xl">
                <CardHeader>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 w-full">
            {submittedAssignments.map((assignment) => (
              <Card key={assignment.id} className="w-full glass-effect border-2 border-blue-500/20 shadow-xl">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 w-full">
            {gradedAssignments.map((assignment) => (
              <Card key={assignment.id} className="w-full glass-effect border-2 border-green-500/20 shadow-xl">
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">

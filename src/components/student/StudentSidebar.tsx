...
import { Home, User, BookOpen, MessageCircle, Trophy, Calendar, LogOut, TrendingUp } from 'lucide-react';
import sahayakLogo from '../../assets/sahayak-logo.png';  // ✅ Use the correct file name
